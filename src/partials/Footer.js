  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-2">
              <ul className="nav social-icons d-md-block">
                <li className="list-inline-item">
                  <a
                ...
                <li className="list-inline-item">
                  <a href="https://wa.me/9643280404" className="p-2">
            ...
            <div className="col-md-2">
              <button
                ...
                className="btn btn-bulkorder btnlg"
              >
                Party Order{" "}
              </button>
            </div>
      ...
      <p className="text-center m-0 p-2">
        Copyright © 2024 EIKO. All Rights Reserved.
      </p>
    </>
  );
}
